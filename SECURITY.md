...
generated assets, and unauthorized publication are security-sensitive. Release
credentials belong only in protected deployment jobs and must never be exposed
to pull request or AI implementation code.
